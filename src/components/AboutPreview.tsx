...
const AboutPreview = () => {
  return (
    <section id="about-preview" className="relative py-20">
      {/* background accents */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid gap-12 md:grid-cols-2 items-center">
        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <p className="text-base sm:text-lg text-muted-foreground max-w-prose">
            We’re a sustainability-first team collecting{" "}
            <strong className="text-emerald-600">used cooking oil (UCO)</strong> from restaurants,
            hotels, and households. Our trained staff provide sealed containers, schedule free
            pickups, and hand over your UCO to{" "}
            <span className="font-medium text-foreground">licensed recyclers</span> with full
            traceability.
          </p>
        ...
        <div className="relative">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-emerald-100 shadow-2xl">
            {/* Replace with your image in /public/images/about-us.jpg */}
            <img
              src="/images/about-us.jpg"
              alt="Our team collecting sealed used cooking oil containers"
              className="w-full h-[420px] sm:h-[460px] object-cover"
              loading="lazy"
              decoding="async"
            />
            {/* soft overlay top for readability */}
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">
                  0₹ pickup • sealed containers • digital receipt
                </div>
              </div>
            </div>
          </Card>
